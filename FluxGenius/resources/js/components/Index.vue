      ...
      <div class="flex items-center justify-between h-16">
        ...
        <div class="hidden md:block">
          <div class="mx-auto flex items-baseline space-x-2">
            ...
            <a href="#" class="text-gray-300 hover:bg-indigo-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Contact</a>      
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    toggleScrollToTopButtonVisibility() {
      this.isScrollToTopVisible = window.scrollY > 200;
    },
  },
 computed: {
    image1() {
